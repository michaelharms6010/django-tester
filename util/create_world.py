...
adj = ["Sunken", "Excited", "Untamed", "Flighty", "Lonely", "Burning", "Cold", "Clear", "Anonymous", "Menacing", "Nostalgic", "Gloomy", "Deserted", "Ominous", "Bleak", "Cold", "Secure", "Eerie", "Desolate", "Deadly", "Blustery", "Shattered", "Forgotten"]
nouns = [
